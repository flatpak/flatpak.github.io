...
:markdown
  ...
  <span class="unselectable">$ </span>flatpak remote-add --gpg-import=gnome-sdk.gpg sdk.gnome.org https://sdk.gnome.org/repo/
  </pre>

  You now have enabled a new Flatpak repo called ```sdk.gnome.org```. Next, install version 1.4 of the Freedesktop SDK and runtime from your newly enabled sdk.gnome.org repository:
